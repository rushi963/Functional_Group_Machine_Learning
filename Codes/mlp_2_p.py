...
def machine(k, temp1, temp2):
    ...
    #parameters = {'solver': ('lbfgs', 'sgd', 'adam'), 'hidden_layer_sizes': [(250, 125), (125, 62)], 'alpha':
    #    [1e-1, 1e-3, 1e-5]}

    clf = MLPClassifier(max_iter=1000, learning_rate_init=0.01, solver='lbfgs', hidden_layer_sizes=(125, 62), alpha=0.1)
